...
def main():
    # 1) fetch_supplementary_info_from_doi

    print("Testing fetch_supplementary_info_from_doi...")
    print(fetch_supplementary_info_from_doi("10.1038/s41586-020-2649-2"))

    # 2) query_arxiv
    print("Testing query_arxiv...")
    print(query_arxiv("large language models alignment", max_papers=2))

    # 4) query_pubmed
    print("Testing query_pubmed...")
    print(query_pubmed("CRISPR gene editing", max_papers=2))

    # 5) search_google
    print("Testing search_google...")
    print(search_google("best practices prompt engineering", num_results=2, language="en"))

    # 6) extract_url_content
    print("Testing extract_url_content...")
    print(extract_url_content("https://huggingface.co/datasets/futurehouse/hle-gold-bio-chem"))

    # 7) extract_pdf_content
    print("Testing extract_pdf_content...")
    print(extract_pdf_content("https://arxiv.org/pdf/1706.03762.pdf"))  # Attention Is All You Need
